...
CREATE TABLE mecanicos(
    ...
    mecanico_equipe_mecanico_id INT NOT NULL,
    ...
    CONSTRAINT fk_mecanico_equipe_mecanico FOREIGN KEY (mecanico_equipe_mecanico_id) REFERENCES equipe_mecanicos(equipe_mecanico_id)
) AUTO_INCREMENT=1;
